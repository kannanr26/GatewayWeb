        ...
        <li v-if="currentUser" class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="#">
              <router-link to="/utilityAddress" class="nav-link text-dark">Utility Address</router-link>
            </a>
            <a class="dropdown-item" href="#">
              <router-link to="/utilityDeity" class="nav-link text-dark">Utility Deity</router-link>
            </a>
            <a class="dropdown-item" href="#">
              <router-link to="/utilityManagement" class="nav-link text-dark">Utility Management</router-link>
            </a>
            <a class="dropdown-item" href="#">
              <router-link to="/utilityPersonal" class="nav-link text-dark">Utility Personal</router-link>
            </a>
            <a class="dropdown-item" href="#">
              <router-link to="/utilityProfession" class="nav-link text-dark">Utility Profession</router-link>
            </a>
          </div>
        </li>
