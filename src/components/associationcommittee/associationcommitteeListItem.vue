...
<div class="clearfix">
  ...
  >
   {{ associationcommittee.associationCommitteeName }}

    <div class="float-sm-right" >
      <button 
        @click="deleteAssociationcommittee"
        type="button"
        title="delete"
         >  X
      </button>
      ...
      <button
        ...
        @click="editAssociationcommittee"
        type="button"
        title="edit"
  ...
  <associationcommitteeAddForm
    v-else
    :populateWith="associationcommittee"
    @close="editAssociationcommittee" />
     </div>
</ul>
</template>
...
export default {
  ...
  methods: {
    deleteAssociationcommittee () {
    //  this.$emit('delete')
       this.$store
        .dispatch('deleteAssociationcommittee', this.associationcommittee)
        .then(() => {
          console.log('SUCCESS');
          this.loading = false;
        })
