...
<template>
  <div class="flex flex-col mt-20 mx-4 border border-info sm:justify-center">
    <h1 class="text-center text-4xl font-bold my-4 mb-12 text-green-500">Add Area</h1>
    ...
    <div class="flex flex-col mt-20 mx-4 sm:justify-center">
      ...
      <select
        ...
        class="browser-default custom-select"
        v-on:change="districtSelected()"
      >
        <option
          v-for="item in getDistrict"
          v-bind:value="item"
          :key="item.districtame"
